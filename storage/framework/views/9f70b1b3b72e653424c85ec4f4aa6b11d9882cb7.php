...
<body>
	<table style="max-width:530px;width:100%;padding:16px 0px;margin:10px auto;background:#ccc;font-family:'Montserrat', sans-serif;" width="100%">
		...
		<tr>
			<td>
				<p style="text-align:center;margin:4px;"><b>Have You Already Found a Home:</b><?php echo e($already_found_home); ?></p>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<p style="text-align:center;margin:4px;"><b>Address:</b><?php echo e($property_address); ?></p>
			</td>
		</tr>
		<tr>
			<td>
...
</html><?php /**PATH /home2/younguxc/public_html/fairfax/resources/views/emails/homePurchase.blade.php ENDPATH**/ ?>