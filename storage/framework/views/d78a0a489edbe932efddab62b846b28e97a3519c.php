    ...
    <body data-spy="scroll" data-offset="70">
        ...
        <section id="service" class="one-service-area two-service-area pb-100 pt-30">
            <div class="container">
                ...
                <!--    <img src="<?php echo asset('public\assets\img\home-two\banner-icon.png'); ?>" class="topB-icon animateMe" data-animation="rollIn">-->
                    ...
                    <div class="row" id="row-rev">
                        ...
                        <div class="col-md-6 col-xs-12 form-group">
                            <div class="advisor-img animateMe" data-animation="bounceIn" id="d">
                                <img src="<?php echo asset('public\assets\img\home-one\advisor.jpg'); ?>" alt="Advisor">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="pt-30">
                    <div class="row">
                        <div class="col-md-6 col-xs-12 form-group">
                            <div class="advisor-img animateMe" data-animation="bounceIn" id="d">
                                <img src="<?php echo asset('public\assets\img\home-one\advisor2.jpg'); ?>" alt="Advisor">
                            </div>
                        </div>
...
</html><?php /**PATH /home2/younguxc/public_html/fairfax/resources/views/about.blade.php ENDPATH**/ ?>