            ...
            <div class="row">
               <div class="col-md-4 col-sm-4 col-xs-12">
                  <div class="bot-30 box gray">
                     ...
                     <ul class="sideUl">
                        <li>
                           <a href="{{ url('home_refinance') }}" class="sideMenu re_bt red">Refinance</a>
                        </li>
                        <li>
                           <a href="{{ url('home_purchase') }}" class="sideMenu pr_bt">Purchase</a>
                        </li>
                     </ul>
                  </div>
               ...
               <div class="col-md-8 col-sm-8 col-xs-12">
                  ...
                  <div class="redLayer">
                     <form action="{{ url('/store_home_refinance_data') }}" method="POST">
                         @csrf  
