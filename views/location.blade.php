...
<html lang="zxx">
   ...
   <body data-spy="scroll" data-offset="70">
      ...
      <div class="ptb-100">
         <!--<div id="map">-->
         <!--    <img src="{!!asset('public\assets\img\home-two\banner-icon.png')!!}">-->
         <!--</div>-->
         <div>
            <img src="{!!asset('public\assets\img\usmap11.jpeg')!!}" class="imageDetails" height="50%">
         </div>
            ...
            <div class="bot-text">
                <div class="row">
                  <div class="col-md-3">
                      ...
                      <img src="{!!asset('public\assets\img\location.jpg')!!}" alt="Logo" height="150px">
                  </div> 
                  <div class="col-md-9">
