   ...
   <!--     <div class="five-quote-area six-quote-area">-->
        ...
        <div id="about" class="two-mission-area ptb-100">
            <div class="container">
                ...
                <div class="mission-content">
                    <img src="{!!asset('public\assets\img\home-two\mission.jpg')!!}" alt="Mission">
        ...
        <div id="about" class="three-about-area four-about-area six-about-area ptb-100">
            <div class="about-shape">
                <img src="{!!asset('public\assets\img\home-six\about4.png')!!}" alt="Shape">
            </div>
            <div class="container-fluid p-0">
                <div class="row align-items-center m-0">
                    ...
                    <div class="col-lg-6 pr-0">
                        <div class="about-img">
                            <img src="{!!asset('public\assets\img\home-six\about1.png')!!}" alt="About">
                            <img src="{!!asset('public\assets\img\home-six\about2.png')!!}" alt="About">
                            <img src="{!!asset('public\assets\img\home-six\about3.png')!!}" alt="About">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="one-contact-area three-contact-area six-contact-area ptb-100">
            <div class="container">
                <div class="contact-content">
                    <form id="contactForm" action="{{ url('submitdata')}}" method="post">
							@csrf
                        <div class="one-section-title three-section-title">
                ...
                <div id="Container" class="row">
                    <div class="col-sm-6 col-lg-6 col-xs-12">
                        <div class="loan-item text-center">
                            <a href="{{ url('home_purchase')}}" target="_blank">
                            <!-- <span>Purchase</span> -->
                    ...
                    <div class="col-sm-6 col-lg-6 col-xs-12">
                        <div class="loan-item text-center">
                            <a href="{{ url('home_refinance')}}" target="_blank">
        ...
        <!--                <div class="among-item">-->
        <!--                    <div class="among-top">-->
        <!--                        <img src="{!!asset('public\assets\img\home-two\among4.png')!!}" alt="Among">-->
        <!--                        <div class="among-icon">-->
        <!--                            <i class='bx bx-user'></i>-->
        <!--                        </div>-->
        <!--                    </div>-->
        ...
        <!--                <div class="among-item">-->
        <!--                    <div class="among-top">-->
        <!--                        <img src="{!!asset('public\assets\img\home-two\among5.png')!!}" alt="Among">-->
        <!--                        <div class="among-icon">-->
        ...
        <!--                <div class="among-item">-->
        <!--                    <div class="among-top">-->
        <!--                        <img src="{!!asset('public\assets\img\home-two\among6.png')!!}" alt="Among">-->
        <!--                        <div class="among-icon">-->
        <!--                            <i class='bx bx-home'></i>-->
        <!--                        </div>-->
        <!--                    </div>-->
