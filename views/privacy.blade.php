...
<html lang="zxx">
    <head>
        ...
        <title>Fairfax Lending | Privacy Policy</title>
    ...
    <body data-spy="scroll" data-offset="70">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-1">
                        <div class="header-social">
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/fairfaxlending/?ref=bookmarks">
                                        <i class='bx bxl-facebook'></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/company/fairfaxlending/?viewAsMember=true">
        ...
        <!-- Banner -->
        <div id="home" class="three-banner-area two-banner-area privacy-banner banner-img two-banner-wrap">
            <div class="d-table">
            ...
            <div class="container">
               <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <h4 class="bot-30">Information We Collect</h4>
                    <p>
                    ...
                    <h4 class="bot-30">Information We Disclose</h4>
                    <p>
