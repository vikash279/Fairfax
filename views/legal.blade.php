...
<html lang="zxx">
    <head>
        ...
        <title>Fairfax Lending | Legal</title>
    ...
    <body data-spy="scroll" data-offset="70">
        ...
        <!-- Banner -->
        <div id="home" class="three-banner-area two-banner-area legal-banner banner-img two-banner-wrap">
            <div class="d-table">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="one-section-title three-section-title">
                        <h2 class="text-left">Legal Disclaimer</h2>
                    </div>
                    <p>
