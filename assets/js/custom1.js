...
// 	$('#v1')[0].contentWindow.postMessage('{"event":"command","func":"' + 'stopVideo' + '","args":""}', '*');
...
// });
 ...
 $('.tabContent a.tabBtn').click(function(){
...
$('.mrgBtn').click(function(){

	$(this).addClass('active').siblings().removeClass('active');

});

$('.sldBtn').click(function(){
...
$('#bt1').click(function(){
    ...
    $('.re_mo, .re_bt, .pr_bt').removeClass('red');
...
$('#bt2').click(function(){
    ...
    $('.ho_eq, .re_bt, .pr_bt').removeClass('red');
...
$(function(){
  $('input[name="property_use"]').click(function(){
    if ($(this).is(':checked'))
    {
       $('.secondtBtn').removeClass('disabled');
    }
  });
});
$(function(){
  $('input[name="already_found_home"]').click(function(){
    if ($(this).is(':checked'))
    {
       $('.fourthBtn').removeClass('disabled');
    }
  });
});
$(function(){
  $('input[name="military_service"]').click(function(){
    if ($(this).is(':checked'))
    {
       $('.seventhBtn').removeClass('disabled');
    }
  });
});
$('#selBtn').change(function(){
    if ($(this).val() != "") {
        $('.eightBtn').removeClass('disabled'); 
    }else{
            $('.eightBtn').addClass('disabled');
         }
   
});
$('input[name="estimated_purchase_price"]').on('input', function() {

         if($(this).val() != "") {
            $('.fifth').removeClass('disabled');

         }else{
            $('.fifth').addClass('disabled');
         }
    });
    
    (function() {
    $('.form-group .validateFld').keyup(function() {

        $('.form-group .validateFld').each(function() {
            if ($(this).val() !== '') {
